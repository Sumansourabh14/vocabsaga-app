      ...
      <View className="flex-1 px-6">
        ...
        <ScrollView className="mt-4">
          ...
          <Text className="font-inter text-base mb-4">
            ...
            handle your data when you use our app. All data is stored locally on
            your device, and no data is sent to or stored on any servers.
          </Text>
          ...
          <Text className="font-inter text-base mb-4">
            All data (e.g., bookmarks) is stored locally on your device. We use
            standard security measures to protect the app, but you are
